@extends('layouts.admin.app', ['title' => 'Edit Data Gejala'])
                    ...
                    <form method="POST" action="{{ route('symptoms.update', $symptom->id) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  @error('id') is-invalid @enderror" id="id"
                                aria-describedby="idHelp" name="id" value="{{ $symptom->id }}" readonly>
                            @error('id')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  @error('symptom_name') is-invalid @enderror"
                                ...
                                value="{{ old('symptom_name', $symptom->symptom_name) }}" autofocus>
                            @error('symptom_name')
